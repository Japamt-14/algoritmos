/**
 * 35. Jogo de Adivinhação de Números O sistema tem um número secreto 
 * armazenado na memória (por exemplo, 42). O programa deve pedir para o 
 * jogador chutar um número. Enquanto o palpite for diferente do número secreto, 
